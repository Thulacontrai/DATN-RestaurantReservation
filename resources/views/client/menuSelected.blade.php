...
<body>
    ...
    <div class="order-header">
        <a href="{{ back() ?? $url }}" class="icon-btn">
    ...
    <div class="order-footer">
        <div class="d-flex justify-content-between mb-2">
            ...
            <span class="total">{{ number_format($item->sum('price')) }}đ</span>
        </div>
        <button class="btn btn-primary btn-submit">Gửi yêu cầu gọi món</button>
    </div>
    <script>
