            ...
            <div class="row">
                <div class="col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-title text-primary">Chỉnh Sửa Nguyên Liệu</div></div>
                        <div class="card-body">
                            <form id="ingredientEditForm" action="{{ route('admin.ingredient.update', $ingredient->id) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" name="price" class="form-control" placeholder="Nhập giá" min="1" max="5000000"
