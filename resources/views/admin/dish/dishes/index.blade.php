            ...
            <div class="col-sm-12 col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.dishes.create') }}" class="btn btn-sm btn-primary d-flex align-items-center">
                                ...
                                <tbody>
                                    @forelse ($dishes as $dish)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="actions">
                                                    <a href="{{ route('admin.dishes.show', $dish->id) }}" class="viewRow">
                                                        <i class="bi bi-list text-green"></i>
                                                    </a>

                                                    <a href="{{ route('admin.dishes.edit', $dish->id) }}" class="">
