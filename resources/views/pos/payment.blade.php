    ...
    <div class="container mt-5">
                    ...
                    <table class="table mt-3 table-hover">
                        ...
                        <tbody>
                            @foreach ($order_items as $index => $item)
                                <tr>
                                    ...
                                    <td class="text-end">{{ $items[$index]->price }} VND</td>
                                    <td class="text-end">{{ $amount = $items[$index]->quantity * $items[$index]->price }}
                                        VND
                                    </td>
                                    <?php $final += $amount; ?>
                                </tr>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-end text-success"><strong>{{ $final }}</strong> VND</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                const totalAmount = {{ $final }}; // Tổng tiền hàng
                const depositAmount = {{ $reservation->deposit_amount }}; // Tiền cọc
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            ...
                            Swal.fire({
                                ...
                                var url =
                                    "{{ route('print.page', $orderId) }}?end_time=" +
                ...
                $('#bankPaymentBtn').click(function() {
                    Swal.fire({
                        ...
                        imageUrl: 'https://img.vietqr.io/image/MB-0964236835-compact2.png?amount=${totalAmount}&addInfo=Thanh Toan Don Hang {{ $orderId }}',
                        imageWidth: 400,
                        imageHeight: 450,
                        showConfirmButton: false,
